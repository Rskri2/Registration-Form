...
var showAlert = exports.showAlert = function showAlert(type, message) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type.toUpperCase(), "\">").concat(message, "</div>");
...
form.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var fname, mname, sname, phone, email, password, day, month, year, dateOfBirth;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          fname = document.querySelector('.mname').value;
...
var updateSetting = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          url = 'http://127.0.0.1:3000/app/v1/registration';
          _context2.next = 4;
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _showAlert.showAlert)('sucess', 'Data successfully saved');
          }
          _context2.next = 11;
          break;
        case 8:
          ...
          (0, _showAlert.showAlert)('error', 'Error while saving data to the database');
        case 11:
        case "end":
  ...
  return function updateSetting(_x2) {
...
icon.addEventListener('click', function (e) {
  e.preventDefault();
  icon.classList.toggle('show-passwords');
});
},{"axios":"../../node_modules/axios/index.js","./showAlert":"showAlert.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
